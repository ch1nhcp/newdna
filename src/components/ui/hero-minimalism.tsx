...
.minimal-cta:hover { background: #0d0d0d; }
...
.minimal-content .minimal-tag {
  font-size: 12px;
  color: var(--muted);
  letter-spacing: 0.08em;
  text-transform: uppercase;
}
.minimal-content .minimal-heading {
  font-size: 22px;
  font-weight: 600;
  color: var(--fg);
}
.minimal-content .minimal-desc {
  font-size: 14px;
  color: var(--muted);
  max-width: 680px;
}
      ...
      <header className="minimal-header">
        ...
        <button className="minimal-cta" type="button">
          Contact
        </button>
      </header>
      ...
      <main className="minimal-hero">
        <div>
          <div className="minimal-kicker">Introducing</div>
          <h1 className="minimal-title">Build fast.<br/>Ship clean.</h1>
          <p className="minimal-subtitle">A minimal React starter focused on clarity, speed, and maintainability.</p>
        </div>
      </main>

      {/* Bottom content */}
      <section className="minimal-content">
        <div className="minimal-tag">Designed for focus</div>
        <div className="minimal-heading">Composable. Accessible. Production-ready.</div>
